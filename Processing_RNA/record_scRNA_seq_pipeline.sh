...
fastq_folder="/data1/jlqu/project/CARE-seq/20210601-CARE-seq-sc/all_data/sc/sciRNA_analysis/rawdata/"
# define the output folder for all processed files
all_output_folder="/data1/jlqu/project/CARE-seq/20210601-CARE-seq-sc/all_data/sc/sciRNA_analysis"
# define the sample ID for each sample (PCR wells)
sample_ID="/data1/jlqu/project/CARE-seq/20210601-CARE-seq-sc/all_data/sc/sciRNA_analysis/sample_ID_384.txt"
# define the gtf file for gene counting
gtf_file="/data1/jlqu/database/mm10/genome_vM11_chr_patch_hapl_scaff_annotation/gencode.vM11.chr_patch_hapl_scaff.annotation.gtf.gz"
...
barcodes="/data1/jlqu/project/CARE-seq/20210601-CARE-seq-sc/all_data/sc/sciRNA_analysis/barcode.txt"
# define the index for alignment (STAR)
index="/data1/jlqu/database/mm10/genome_vM11_chr_patch_hapl_scaff_annotation/"
# define the sub_script folder
script_folder="/data1/jlqu/bin/sci-CAR_analysis-master/scRNA_seq_pipe/sub_script/"
script_path="/data1/jlqu/bin/sci-CAR_analysis-master/scRNA_seq_pipe/sub_script/"

#define the mismatch rate for removing duplicates:
mismatch=1

#define the bin of python
python_path="/data1/jlqu/opt/anaconda3/envs/sciRNA/bin/"
...
#for sample in $(cat $sample_ID); do echo changing name $sample; mv $input_folder/$sample*.1*gz $input_folder/$sample.R1.fastq.gz; mv $input_folder/$sample*.2*gz $input_folder/$sample.R2.fastq.gz; done
...
ln -s $fastq_folder/* $UMI_attached_R2/ #already preprocessed
